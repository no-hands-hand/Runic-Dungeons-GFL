...
public class BlockWitherGlass extends Block {
    ...
    public BlockWitherGlass() {
        super(Material.GLASS);
        this.setHardness(5.0F);
        this.setResistance(-1.0F);
        this.setUnlocalizedName("witherRunicGlass");
        this.setRegistryName(RunicDungeons.MODID, "wither_runic_glass");
