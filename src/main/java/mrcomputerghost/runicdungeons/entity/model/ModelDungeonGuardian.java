package mrcomputerghost.runicdungeons.entity.model;
...
public class ModelDungeonGuardian extends ModelBase {
    ...
    public ModelDungeonGuardian() {
        this(0.6F);
    }

    public ModelDungeonGuardian(float p_i1161_1_) {
        this(p_i1161_1_, -11.0F);
    }

    public ModelDungeonGuardian(float p_i46362_1_, float p_i46362_2_) {
        int i = 128;
        int j = 128;
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        EntityDungeonGuardian guardian = (EntityDungeonGuardian) entitylivingbaseIn;
        int i = guardian.getAttackTimer();
